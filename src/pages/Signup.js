        ...
        <Grid m_margin margin="5vh 20px 0px 20px" width="90%">
          ...
          {user_info.email ? (
            emailCheck(user_info.email) ? (
              dupliEmail ? (
                <Text color="#E4E4E4" size="13px" lineheight="18px">
                  *사용가능한 이메일입니다.
                </Text>
              ) : (
          ...
          <InputBox>
            ...
            {user_info.password ? (
              pwdCheck(user_info.password) ? (
                ...
                <div
                  onClick={() => {
                    setUserInfo({ ...user_info, password: "" });
                  }}
                >
                  {X}
                </div>
        ...
        <Grid margin="5vh 20px 0px 20px" width="90%">
          ...
          <InputBox>
            <Input
              ...
              width="80%"
              type="password"
              value={user_info.pwdcheck}
              _onChange={(e) => {
                setUserInfo({ ...user_info, pwdcheck: e.target.value });
              }}
            />
            {user_info.pwdcheck ? (
              pwdDupli(user_info.password, user_info.pwdcheck) ? (
                ""
              ) : (
                <div
                  onClick={() => {
                    setUserInfo({ ...user_info, pwdcheck: "" });
                  }}
                >
                  {X}
                </div>
        ...
        pwdCheck(user_info.password) ? (
          <SignupButton>
            <Grid display="flex" fd="column-reverse" height="100%">
              <Button bg="#FFE899" height="56px" margin="0px" _onClick={signup}>
