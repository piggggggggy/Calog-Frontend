    ...
    <React.Fragment>
      ...
      <Helmet>
        ...
        <meta
          ...
          content="공지사항, 알림, 의견 보내기를 할 수 있어요!"
        />
      ...
      <Container>
        ...
        <label htmlFor="profile_img">
          <Cameradiv>{Camera}</Cameradiv>
          <File_box
            type="file"
            id="profile_img"
            ref={profile}
            multiple
            onChange={store_profile}
          />
        </label>
        ...
        <Bottombg>
          ...
          <Grid
            display="flex"
            margin="10vh 60% 2.7vh 5.7%"
            m_margin="10vh 60% 2.7vh 5.7%"
            width="auto"
          >
            {nickModifyClass ? (
              <div>
              ...
              <Text m_size="23px" bold lineheight="34px" size="28px" margin="0">
                {user_info?.nickname}
              </Text>
            )}
            <EditBtn
              onClick={() => {
                nickModifyClass ? modify_nick() : setNickClass(1);
              }}
            >
              <GrEdit />
            </EditBtn>
          ...
          {height || weight ? (
            <BodySpecBox>
              <ContentBS>
                ...
                <Text m_size color="#8C8C8C" size="12px" line-height="14.4px">
                  <Hover onClick={M_height}>
                    {m_height ? "수정완료" : <u>수정</u>}
                  </Hover>
                </Text>
              </ContentBS>
              ...
              <ContentBS>
                ...
                <Text m_size color="#8C8C8C" size="12px" line-height="14.4px">
                  <Hover onClick={M_weight}>
                    {m_weight ? "수정완료" : <u>수정</u>}
                  </Hover>
                </Text>
              </ContentBS>
