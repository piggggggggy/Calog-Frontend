      ...
      <SpinnerContainer>
          <Spinner1>
            <svg viewBox="0 0 816 663" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M526 289C526 289 679.256 287.438 806 475" stroke="#565656" strokeWidth="20" strokeLinecap="round" strokeLinejoin="round"/>
          ...
          <Spinner2>
            <svg viewBox="0 0 589 663" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <path d="M367 194L354 207" stroke="#ED6358" strokeWidth="7" strokeLinecap="round" strokeLinejoin="round"/>
              <path d="M384 194L371 207" stroke="#ED6358" strokeWidth="7" strokeLinecap="round" strokeLinejoin="round"/>
          ...
          <Spinner3>
            <svg viewBox="0 0 626 752" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <path d="M419.269 350.61C419.269 350.61 563.279 298.079 615.902 78.0518" stroke="#565656" strokeWidth="20" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
          </Spinner3>
      </SpinnerContainer>
    </React.Fragment>
