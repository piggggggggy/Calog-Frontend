...
const Record_ListBody = (props) => {
  ...
  return (
    <React.Fragment>
      <Grid
        margin="47% auto 24px auto"
        height="auto"
        m_margin="50% auto 24px auto"
        display={short}
      >
        {cart_list.map((c, idx) => {
          // 리스트가 6개 이상일 경우
      ...
      {cart_list.length > 5 && (
        ...
        >
          ...
          >
            <path
              d="M18.23 0.229981L20 1.99998L10 12L-7.73692e-08 1.99998L1.77 0.229981L10 8.45998L18.23 0.229981Z"
              fill="#757575"
            />
          </svg>
        </Grid>
      ...
      >
        ...
        >
          <path
            d="M2.87746 12.1475L1.07579 10.4098L10.8936 0.23083L21.0725 10.0486L19.3348 11.8503L10.9575 3.77025L2.87746 12.1475Z"
            fill="#757575"
          />
        </svg>
      </Grid>
