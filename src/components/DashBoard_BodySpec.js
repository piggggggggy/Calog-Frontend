    ...
    <React.Fragment>
      <Wrap>
        <Grid is_flex text_align="center">
          {/* 키 */}
          <Grid>
            <Text size="12px" m_size="11px">
              키
            </Text>
            <Grid display={hHide} m_margin="11% 0 0 0">
              <Text size="13px" bold margin="10% 0 0 0" m_size="12px">
                {height === "" ? 0 : height}cm
              </Text>
            </Grid>
            <Grid display={hShow}>
            ...
            <Grid margin="10% 0 0 0" m_margin="10% 0 0 0">
              <Grid display={hShow} _onClick={heightOn}>
                ...
                >
                  <path
                    id="hShow"
                    d="M8 10.5901C10.7564 10.5901 13.2145 9.14412 14.4145 6.8564C13.9855 6.0282 13.3818 5.3154 12.6618 4.73838L13.6873 3.7812C14.6982 4.61619 15.4982 5.66162 16 6.8564C14.7418 9.83655 11.6364 11.9478 8 11.9478C7.07636 11.9478 6.18909 11.812 5.35273 11.5608L6.55273 10.4407C7.02545 10.529 7.50545 10.5901 8 10.5901ZM7.22182 9.81619L8.72727 8.41097C9.14182 8.24125 9.47636 7.92898 9.65818 7.54204L11.1636 6.13681C11.2218 6.36762 11.2655 6.61201 11.2655 6.86319C11.2727 8.54674 9.80364 9.91123 8 9.91123C7.73091 9.91123 7.47636 9.87728 7.22182 9.81619ZM0.734545 12.036L2.68364 10.2167C1.49818 9.34778 0.56 8.19373 0 6.8564C1.25818 3.87624 4.36364 1.76501 8 1.76501C9.10545 1.76501 10.1673 1.96188 11.1418 2.32167L13.6291 0L14.6545 0.95718L1.76 13L0.734545 12.036ZM6.18909 6.94465L8.08727 5.17285C8.05818 5.16606 8.02909 5.15927 8 5.15927C6.99636 5.15927 6.18182 5.91958 6.18182 6.8564C6.18182 6.89034 6.18909 6.9107 6.18909 6.94465ZM3.71636 9.25274L4.98909 8.06475C4.82182 7.69138 4.72727 7.28407 4.72727 6.8564C4.72727 5.17285 6.19636 3.80157 8 3.80157C8.45818 3.80157 8.89455 3.88982 9.28727 4.04595L10 3.38068C9.36 3.21775 8.69091 3.12271 8 3.12271C5.24364 3.12271 2.78545 4.56867 1.58545 6.8564C2.09455 7.82715 2.83636 8.6282 3.71636 9.25274Z"
                    fill="#9B9B9B"
                  />
                </Svg>
              </Grid>
