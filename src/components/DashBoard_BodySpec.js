    ...
    <React.Fragment>
      <Wrap>
        <Grid is_flex text_align="center" padding="4.5% 0 0 0">
          {/* 키 */}
          <Grid>
            <Text size="12px">키</Text>
            <Grid display={hHide}>
              <Text size="13px" bold margin="7% 0 0 0">180cm</Text>
            </Grid>
            <Grid display={hShow}>
                <Text size="13px" bold margin="7% 0 0 0">쉿☝🏻비밀!</Text>
            </Grid>
            {/* 숨김/표시 버튼 */}
          ...
          {/* 몸무게 */}
          <Grid>
            <Text size="12px">몸무게</Text>
            <Grid display={wHide}>
              <Text size="13px" bold margin="7% 0 0 0">80kg</Text>
            </Grid>
            <Grid display={wShow}>
                <Text size="13px" bold margin="7% 0 0 0">쉿☝🏻비밀!</Text>
            </Grid>
          ...
          {/* 기초대사량 */}
          <Grid>
            <Text size="12px">기초대사량</Text>
            <Grid display={kHide}>
              <Text size="13px" bold margin="7% 0 0 0">1700kcal</Text>
            </Grid>
            <Grid display={kShow}>
                <Text size="13px" bold margin="7% 0 0 0">쉿☝🏻비밀!</Text>
            </Grid>
