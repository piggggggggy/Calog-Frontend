...
const CalenderDetail_Info = (props) => {
  ...
  const well =
    (bmr - twenty <= totalCalories && totalCalories < bmr - ten) ||
    (bmr + ten < totalCalories && totalCalories <= bmr + twenty);
        ...
        <Grid is_flex padding="0 9%" height="100%">
          ...
          <Grid width="auto">
            ...
            >
              ...
              <path
                d="M17.8368 18.852C18.3682 18.319 18.6667 17.596 18.6667 16.8422C18.6667 16.0884 18.3682 15.3655 17.8368 14.8325C17.3054 14.2994 16.5848 14 15.8333 14C15.0819 14 14.3612 14.2994 13.8299 14.8325C13.2985 15.3655 13 16.0884 13 16.8422C13 17.596 13.2985 18.319 13.8299 18.852C14.3612 19.385 15.0819 19.6845 15.8333 19.6845C16.5848 19.6845 17.3054 19.385 17.8368 18.852Z"
                fill="white"
              />
              <path
                d="M29.1701 18.852C28.6388 19.385 27.9181 19.6845 27.1667 19.6845C26.4152 19.6845 25.6945 19.385 25.1632 18.852C24.6318 18.319 24.3333 17.596 24.3333 16.8422C24.3333 16.0884 24.6318 15.3655 25.1632 14.8325C25.6945 14.2994 26.4152 14 27.1667 14C27.9181 14 28.6388 14.2994 29.1701 14.8325C29.7015 15.3655 30 16.0884 30 16.8422C30 17.596 29.7015 18.319 29.1701 18.852Z"
                fill="white"
              />
              <path
                d="M16.7921 24.6744C17.223 24.9291 17.5356 25.3448 17.6614 25.8304C18.1544 27.4807 19.9148 28.2103 21.5015 28.2103C23.0882 28.2103 24.8505 27.4789 25.3416 25.8304C25.4748 25.3535 25.7887 24.948 26.2162 24.7004C26.6437 24.4529 27.1509 24.383 27.6291 24.5059C28.1072 24.6287 28.5185 24.9344 28.7748 25.3576C29.0311 25.7808 29.1121 26.2879 29.0004 26.7702C28.022 30.0823 24.8732 31.9999 21.5015 31.9999C18.2583 31.9999 14.8318 30.1051 14.0026 26.774C13.8793 26.2878 13.9533 25.7724 14.2083 25.3408C14.4633 24.9092 14.8785 24.5967 15.3629 24.4718C15.8473 24.3469 16.3612 24.4197 16.7921 24.6744Z"
                fill="white"
              />
            </Svg>
            <br />
