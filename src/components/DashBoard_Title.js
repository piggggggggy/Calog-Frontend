      ...
      <Line>
        ...
        {is_login ? (
          <React.Fragment>
            ...
            {over_bmr && bmr !== 0 ? (
              <Text size="22px" m_size="18px" color={"#E24444"}>
                {user_info.nickname}님!
              </Text>
            ) : (
              <Text size="22px" m_size="18px">
                {user_info.nickname}님!
              </Text>
            )}
              ...
              <React.Fragment>
                ...
                {bmr !== 0 ? (
                  <React.Fragment>
                    ...
                    {Average && (
                      <React.Fragment>
                        <Text size="22px" bold m_size="18px">
                          오늘의 칼로리를
                          <br />
                          충분히 채웠어요
                        </Text>
                    ...
                    {over_bmr && (
                      <React.Fragment>
                        <Text size="22px" bold m_size="18px" color={"#E24444"}>
                          {how_over}kcal
                          <br />
                          초과했어요
                        </Text>
          ...
          <React.Fragment>
            ...
            <Grid padding="1vh 0 0 0;">
              <Text size="15px" bold color={theme.color.gray_6} m_size="13px">
                {" "}
                오늘은 어떤 음식을 드실건가요?
              </Text>
            </Grid>
