...
const DashBoard_When = (props) => {
  ...
  const foodRecords = history.location.pathname.includes("dashboard")
    ? props[0]
    : props?.foodRecords;
    ...
    <React.Fragment>
      ...
      {foodRecords?.length > 0 ? (
        <Wrap>
          ...
          <When
            onClick={() => {
              selectType("midnightSnack");
            }}
          >
            <Text
              size="17px"
              bold
              color={type === "야식" ? "black" : "#c4c4c4"}
              m_size="15px"
              cursor="pointer"
            >
              야식
        ...
        <Wrap>
          {/* 아침 */}
          <When>
            <Text size="17px" bold color={"#c4c4c4"} m_size="15px">
              아침
            </Text>
          </When>
